...
namespace Tqdev\PhpCrudApi {
    ...
    // Nilai-nilai database sesuai permintaan Anda
    $config = new Config([
        'driver'   => 'mysql',              // dbDriver
        'address'  => 'localhost',          // dbHost
        'database' => 'db_toko_material',   // dbName
        'username' => 'root',               // dbUsername
        'password' => '',                   // dbPassword
        'port'     => '3306',               // default port untuk mysql
        'debug'    => true                  // Aktifkan ini untuk melihat error jika gagal konek
    ]);
